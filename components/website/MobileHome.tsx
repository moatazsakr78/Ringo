          ...
          <div className="flex items-center gap-2 w-full justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className={`h-14 w-14 ${logoRoundingClass} overflow-hidden bg-transparent flex items-center justify-center`}>
                <img src={logoUrl || '/assets/logo/Ringo.png'} alt={companyName} className="h-full w-full object-cover" />
              </div>
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              <div className="flex items-center gap-2 mb-3">
                <img src={logoUrl || '/assets/logo/Ringo.png'} alt={companyName} className="h-6 w-6 object-contain" />
