...
interface ResizableTableProps {
  ...
  reportType?: 'MAIN_REPORT' | 'PRODUCTS_REPORT' | 'CATEGORIES_REPORT' | 'CUSTOMERS_REPORT' | 'CUSTOMER_INVOICES_REPORT' | 'DAILY_SALES_REPORT' | 'HOURLY_SALES_REPORT' | 'PROFIT_MARGIN_REPORT' | 'SUPPLIER_STATEMENT_REPORT' | 'SUPPLIER_INVOICES_REPORT' | 'SUPPLIER_INVOICE_DETAILS_REPORT' | 'SUPPLIER_PAYMENTS_REPORT' // for localStorage key
