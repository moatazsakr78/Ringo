    ...
    printWindow.document.write(`
      ...
      <body>
        <div class="header">
          ...
          <img src="${logoUrl || '/assets/logo/Ringo2.png'}" class="logo" />
        </div>
        ...
        <div className="relative flex items-center min-h-[60px] md:min-h-[80px]">
          <div className="w-full px-4 flex items-center justify-between min-h-[60px] md:min-h-[80px]">
            ...
            <div className="flex items-center">
              <img src={logoUrl || '/assets/logo/Ringo2.png'} alt={companyName} className="h-12 w-12 md:h-16 md:w-16 object-contain" />
            </div>
          </div>
        </div>
      </header>
