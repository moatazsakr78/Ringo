...
export default function KPICard({
  ...
  if (loading) {
    return (
      <div className="bg-[#374151] rounded-lg border border-gray-600 p-6 animate-pulse">
  ...
  return (
    <div className="bg-[#374151] rounded-lg border border-gray-600 p-6 hover:border-gray-500 transition-colors">
      <div className="flex items-center justify-between mb-4">
      ...
      <div className="text-gray-300 text-sm text-right mt-2">{title}</div>
    </div>
  );
}
